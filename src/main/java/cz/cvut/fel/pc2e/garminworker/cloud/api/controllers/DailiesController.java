...
import cz.cvut.fel.pc2e.garminworker.cloud.api.dto.DailiesPushNotificationDto;
import cz.cvut.fel.pc2e.garminworker.cloud.api.dto.DailySummaryDto;
...
public class DailiesController {
    ...
    public DailiesController(RawMessageProducer rawMessageProducer, HeartRateMessageProducer heartRateMessageProducer, DeviceRepository deviceRepository) {

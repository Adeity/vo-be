...
import cz.cvut.fel.pc2e.garminworker.dto.ActivityIntensityEnum;
import cz.cvut.fel.pc2e.garminworker.dto.EpochSummaryDto;
import cz.cvut.fel.pc2e.garminworker.dto.EpochsPushNotificationDto;
...
public class HealthEpochController {
    ...
    private final PeriodOffsetDao periodOffsetRepository;

    public HealthEpochController(RawMessageProducer rawMessageProducer, ActivityMessageProducer activityMessageProducer, DeviceDao deviceRepository, PeriodOffsetDao periodOffsetRepository) {
